...
My personal keymap is in `keyboard/satan/keympas/keymap_mp.c`, which is the default file that `make` will use. Install the dependencies previously described, and flash list so:

...
[_BW] = KEYMAP(
  ...
  KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, F(9), KC_RALT, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT),
  /* Keymap 1: _MV Layer
   * ,-----------------------------------------------------------------------------.
   * |     |  |   |   |   |  |   |   |   |   |   |   |   |   |   |	|    |    |    |
   * |-----------------------------------------------------------|	|--------------|
...
[_MV] = KEYMAP(
  ...
  KC_NO,  KC_NO, KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO, KC_NO, KC_NO, RESET, KC_NO, KC_NO, KC_NO, \
  ...
  KC_NO,  KC_NO, KC_NO,  KC_NO, F(10), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO),
